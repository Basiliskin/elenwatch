...
- 2026-08-31 | horizon 2 | completed | 6 phases done (0 blocked, 0 amendments, 0 overrides) — wire/capture body split, createRequire peer load, dist/esm .js-specifier rewrite + verifier + prepublishOnly, pack-and-import smoke test, cap-trip console.error gated, full README — see horizon-02 roadmap.md
